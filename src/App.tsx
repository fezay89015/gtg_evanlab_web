...
const RESULTS: Record<number, ResultType> = {
  1: {
    ...
    advice: "你目前正處於能量最旺盛、但也最容易失控的「衝撞期」。\n面對困境，你的第一反應是用蠻力打破它。道家提醒，過度的剛猛容易折損。你該調整的心態是「學會留白」。在即將發怒或衝動決定前，給自己三秒鐘的停頓。你的破壞力已經足夠，若能加上一點對大局的冷靜判斷，你將無堅不摧。",
  ...
  2: {
    ...
    advice: "你正處於為團隊或目標殫精竭慮的階段，試圖以極致的腦力掌控一切。\n然而，道家言「慧極必傷」。面對不管怎麼算計都無法扭轉的壞局面，你必須學會「知命與放下」。你最大的課題是容許事物失控，並坦然接受人力有時而窮。適時地將責任外包，回歸對自身健康的關注，才是長遠之道。",
  ...
  3: {
    ...
    advice: "你處於「煉神還虛」的階段，對很多事已經看淡。\n面對惡劣的局面，你不會焦慮，因為你明白因果循環。但要注意，過度出世可能會讓你顯得消極或脫離現實。你的修煉之道在於「和其光，同其塵」。不需要強迫自己加入爭鬥，但可以將你的智慧轉化為療癒他人的力量，在紅塵中修行，方為大隱。",
  ...
  4: {
    ...
    advice: "你正處於建立事業或掌握主導權的巔峰期。\n你不缺解決問題的手段，但你面臨的最大挑戰是內心的多疑與孤高。面對不好的局面，你容易陷入無人可信任的深淵。你該調整的心態是「化敵為友」。試著卸下過度的防備，允許身邊出現真實且純粹的情感交流，這將是你化解高處不勝寒的唯一解藥。",
  ...
  5: {
    ...
    advice: "你目前可能正處於受制於人或大環境不利的階段。\n你的修煉已進入「知白守黑」的境界。面對欺壓或困境，你的化解之道就是「等」。道家言「夫唯不爭，故天下莫能與之爭」。不要在意一時的委屈，保全自身的健康與心智。當時間的長河耗盡了對手的氣數，那便是你一擊必殺的時刻。",
  ...
  6: {
    ...
    advice: "你正處於一個需要感召他人、以無形推動有形的階段。\n面對失敗或不好的局面，你的化解之道在於「無為而治」。你不需要是最強壯或最聰明的，你只需要提供一個包容的胸懷。將危機轉化為凝聚人心的契機，你的柔弱正是你最強大的武器，能以水滴石穿之勢成就大業。",
  ...
  7: {
    ...
    advice: "你已經在某些領域建立了地位，正經歷「守成與傲氣」的階段。\n面對不利的局面，你最需要調整的是「放下執念」。水能包容萬物而不爭，世間並非非黑即白，適度的低頭並不代表背叛原則。化解危機的關鍵在於柔軟你的身段，接納不同的聲音。",
  ...
  8: {
    ...
    advice: "你正處於高度依賴腦力與展現才華的階段。\n道家提醒「大巧若拙」，過度展現鋒芒容易招致嫉妒或反噬。面對不順遂，不要急著用更強烈的手段證明自己。你該學習的是「藏鋒」。將部分的心力收回，培養從容的氣度，當你不急著贏的時候，往往能贏得更漂亮。",
  ...
  9: {
    ...
    advice: "你正處於「萬軍叢中過，片葉不沾身」的境界。\n你可能背負著別人的請託，正在專注執行任務。面對八方敵意，你的化解之道在於「守一」。不要被外界的利益誘惑或恐懼干擾。只要保持內心的光明與無私，憑藉平日積累的實力，你便能全身而退。",
  ...
  10: {
    ...
    advice: "你正處於夾縫中求生存或守成的階段。\n你內心有想突破的渴望，但又受制於現實的考量。道家修煉在此時強調「動靜皆宜」。面對困局，不需要急著表態或選邊站，維持恐怖平衡也是一種策略。你的功課是釐清哪部分是外界的期望，哪部分是你真實的渴望，在平衡中慢慢滲透出自己的影響力。",
            ...
            <div className="p-10 bg-[#ffffff]">
              <div className="space-y-8">
                <section>
                  ...
                  <p className="parchment-text leading-relaxed bg-[#ffe6d7]/30 p-4 rounded border border-[#e9b156]/10 whitespace-pre-wrap">
                    {result.description}
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="parchment-text leading-relaxed whitespace-pre-wrap">
                      {result.advice}
                    </p>
                  </div>
                </section>
